...
## The “1 to 3 Years” Job Description that reads like '5+ Years'

I was reading job descriptions for 1 to 3 year roles, and had to scroll back up to confirm it wasn’t senior. It’s no longer just: “know Java.”

Rather it was like:

**Java + Spring Boot + Microservices + AWS + Docker + Kubernetes + CI/CD + System Design + Observability + Security basics + Strong DSA** then call it 1 to 3 years, all for a “Junior” title.
...
When you ask for “1 to 3 years experience” but expect “5 years maturity,” you don’t just filter candidates, **you distort the entire market**.
